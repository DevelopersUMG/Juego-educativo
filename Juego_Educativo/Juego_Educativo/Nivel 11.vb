Public Class Nivel_11
    ...
    Public Function calificandoonce()
        '--------------------------------------   Primer textbox     -----------------------------------------------------

        If txtresp1_nivel1 = "blue" Then
    ...
    Private Sub instruccinN1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles instruccinN1.Click
