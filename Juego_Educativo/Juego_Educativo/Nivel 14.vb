Public Class Nivel_14
    ...
    Public Function calificandocatorce()
        '--------------------------------------   Primer textbox     -----------------------------------------------------

        If txtresp1_nivel4 = "girl" Then
        ...
        If txtresp5_nivel4 = "old woman" Then
